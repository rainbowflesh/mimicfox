...
| `uc.tweak.autohide-sidebar`             | null or 0 or 1 or 2           | Auto hide sidebar, =0 no auto, =1 expand entire sidebar-box, =2 draw sidebar-box over browser (with broken blur effect)                                                                                 |
