...
| `uc.tweak.pip`                          | TRUE/false                        | Enable Picture-in-Picture styles ![](./assets/previews/pip.png)                                                                                                |
| `uc.tweak.enable-nebula-animations`            | TRUE/false                        | Enable animations from [nebula](https://github.com/JustAdumbPrsn/Zen-Nebula)                                                                                   |
